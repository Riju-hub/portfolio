...
//               >
//                 {/* Timeline Dot (Perfectly centered on the line for desktop layouts) */}
...
//                     <div>
//                       <h3 className="text-xl font-bold text-purple-400 group-hover:text-transparent group-hover:bg-clip-text group-gradient group-hover:bg-gradient-to-r group-hover:from-purple-400 group-hover:to-pink-400 transition-all duration-300">
//                         {data.role}
//                       </h3>
//                       <p className="text-gray-400 text-sm font-medium mt-0.5">{data.company}</p>
//                     </div>
//                     <div>
