...
import { FaBars, FaHome, FaUser, FaCode, FaLaptopCode, FaGraduationCap, FaEnvelope, FaGithub, FaLinkedin, FaTwitter } from 'react-icons/fa';
        ...
        <div className='hidden md:flex items-center gap-1 lg:gap-2 font-medium'>
          {NAV_ITEMS.map(({ id, label }) => (
            <button
              ...
              className={`relative px-4 py-2 rounded-full capitalize transition-all duration-300 text-sm lg:text-base ${
